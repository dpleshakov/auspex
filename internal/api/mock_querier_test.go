...
func (m *mockQuerier) CountCompletingToday(ctx context.Context) (int64, error) { return 0, nil }
func (m *mockQuerier) CountIdleBlueprints(ctx context.Context) (int64, error)  { return 0, nil }
func (m *mockQuerier) CountOverdueJobs(ctx context.Context) (int64, error)     { return 0, nil }
