...
func TestGetCharacterJobs_FiltersByStatus(t *testing.T) {
	payload := `[
		...
		{"job_id":4,"blueprint_id":400,"installer_id":42,"activity_id":4,"status":"cancelled","start_date":"2026-02-17T10:00:00Z","end_date":"2026-02-19T10:00:00Z"}
	]`
...
func TestGetCharacterJobs_UsesCorrectURL(t *testing.T) {
	...
	c := newTestClient(srv)
	c.GetCharacterJobs(context.Background(), 42, "tok")
...
func TestGetCorporationJobs_UsesCorrectURL(t *testing.T) {
	...
	c := newTestClient(srv)
	c.GetCorporationJobs(context.Background(), 99999, "tok")
